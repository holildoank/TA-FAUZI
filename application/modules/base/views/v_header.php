    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="<?php echo base_url() ?>" target="_blank">
                <img src="<?php echo base_url() ?>/assets/layouts/layout/img/logo12.png" alt="logo" class="logo-default" /> </a>
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        <i class="icon-bell"></i>
                        <span class="badge badge-default" id="konfirmasi" title="Reservation confirmation"> 0 </span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="external" >
                            <h3>
                                <span class="konfirmasi" >0 confirmation</span>Reservation confirmation</h3>
                ...
                <li class="dropdown dropdown-extended dropdown-inbox" id="header_inbox_bar ">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        ...
                        <span class="badge badge-default" id="notifikasi" title="Reservation pending"> 0  </span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="external">
                            <h3>You have
                                <span class="bold notifikasi">0</span> Reservation pending</h3>
                            <a href="<?php echo base_url() ?>reservation">view all</a>
                        </li>
                        <li>
...
<script type="text/javascript">
    function cek(){
	    $.ajax({
	        url: "<?php echo site_url('reservation/notifikasi')?>",
	        cache: false,
