                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">List of staff</span>
                            <a href="<?php echo site_url() ?>staff/create" class="btn btn-primary btn-xs" id="btn_add"><i class="fa fa-plus"></i> Add New</a>
                        </div>
                        <div class="tools">
                        </div>
                    </div>
...
table = $('#example').DataTable({
    ...
    "ajax": {
        "url": "<?php echo site_url('staff/list')?>",
        "type": "POST",
        data: function (d) {
...
//  e.preventDefault();
//  $("#modal_form").load('<?php echo site_url(); ?>/staff/create',function() {
//      $(this).modal("show");
//  });
// });
...
function btn_edit(id) {
    $("#modal_form").load('<?php echo site_url(); ?>/staff/update/'+id,function() {
        $(this).modal("show");
    });
}
...
function btn_delete(id) {
    swal({
            ...
            function(){
                $.post('<?php echo site_url() ?>/staff/delete/'+id, {}, function(res) {
                    table.ajax.reload();
                    swal({
                        title: "Deleted!",
