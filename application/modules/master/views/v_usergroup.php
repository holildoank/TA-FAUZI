    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
				...
				<li>
                    <a href="javascript:;">User Group</a>
                    <i class="fa fa-circle"></i>
                </li>
            </ul>
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> User Group
        </h3>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
        <div class="row">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">List of User Group</span>
...
table = $('#example').DataTable({
    ...
    "ajax": {
        "url": "<?php echo site_url('usergroup/list')?>",
        "type": "POST",
        data: function (d) {
...
$("#btn_add").click(function(e) {
	e.preventDefault();
	$("#modal_form").load('<?php echo site_url(); ?>/usergroup/create',function() {
		$(this).modal("show");
	});
});

function btn_edit(id) {
	$("#modal_form").load('<?php echo site_url(); ?>/usergroup/update/'+id,function() {
		$(this).modal("show");
	});
}
...
function btn_delete(id) {
	swal({
			...
			function(){
				$.post('<?php echo site_url() ?>/usergroup/delete/'+id, {}, function(res) {
					table.ajax.reload();
					swal({
						title: "Deleted!",
