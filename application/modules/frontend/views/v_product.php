                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">List of Product</span>
                            <a href="<?php echo site_url() ?>product/create" class="btn btn-primary btn-xs" id="btn_add"><i class="fa fa-plus"></i> Add New</a>
                        </div>
                        <div class="tools">
                        </div>
                    </div>
...
table = $('#example').DataTable({
    ...
    "ajax": {
        "url": "<?php echo site_url('product/list')?>",
        "type": "POST",
        data: function (d) {
            d.filter_service_id = $('#service_id').val();
            d.filter_staff_id = $('#staff_id').val();
        }
    },
...
function btn_edit(id) {
	$("#modal_form").load('<?php echo site_url(); ?>/product/update/'+id,function() {
		$(this).modal("show");
	});
}
...
function btn_delete(id) {
	swal({
			...
			function(){
				$.post('<?php echo site_url() ?>/product/delete/'+id, {}, function(res) {
					table.ajax.reload();
					swal({
						title: "Deleted!",
