    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
				...
				<li>
                    <a href="javascript:;">Our Moments</a>
                    <i class="fa fa-circle"></i>
                </li>
            </ul>
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">List of Our Moments</span>
                            <a href="<?php echo site_url() ?>gallery/create" class="btn btn-primary btn-xs" id="btn_add"><i class="fa fa-plus"></i> Add New</a>
                        </div>
                        <div class="tools">
                        </div>
                    </div>
...
table = $('#example').DataTable({
    ...
    "ajax": {
        "url": "<?php echo site_url('gallery/list')?>",
        "type": "POST",
        data: function (d) {
...
function btn_edit(id) {
	$("#modal_form").load('<?php echo site_url(); ?>/gallery/update/'+id,function() {
		$(this).modal("show");
	});
}
...
function btn_delete(id) {
	swal({
			...
			function(){
				$.post('<?php echo site_url() ?>/gallery/delete/'+id, {}, function(res) {
					table.ajax.reload();
					swal({
						title: "Deleted!",
