                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">List of Testimonial</span>
                            <!-- <button type="button" class="btn btn-primary btn-xs" name="button" id="btn_add"><i class="fa fa-plus"></i> Add New</button> -->
                            <a href="<?php echo site_url() ?>testimonial/create" class="btn btn-primary btn-xs" id="btn_add"><i class="fa fa-plus"></i> Add New</a>
                        </div>
                        <div class="tools">
                        </div>
                    </div>
...
table = $('#example').DataTable({
    ...
    "ajax": {
        "url": "<?php echo site_url('testimonial/list')?>",
        "type": "POST",
        data: function (d) {
...
function btn_edit(id) {
    $("#modal_form").load('<?php echo site_url(); ?>/testimonial/update/'+id,function() {
        $(this).modal("show");
    });
}
...
function btn_delete(id) {
    swal({
            ...
            function(){
                $.post('<?php echo site_url() ?>/testimonial/delete/'+id, {}, function(res) {
                    table.ajax.reload();
                    swal({
                        title: "Deleted!",
