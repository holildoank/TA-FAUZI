    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
				...
				<li>
                    <a href="javascript:;">Time Schedule Staff</a>
                    <i class="fa fa-circle"></i>
                </li>
            </ul>
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> Schedule Staff
        </h3>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
        <div class="row">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">List of Schedule Staff</span>
...
$("#btn_add").click(function(e) {
	e.preventDefault();
	$("#modal_form").load('<?php echo site_url(); ?>/schedule/create',function() {
		$(this).modal("show");
	});
});

function btn_edit(id) {
	$("#modal_form").load('<?php echo site_url(); ?>/schedule/update/'+id,function() {
		$(this).modal("show");
	});
}
//
function btn_delete(id) {
	swal({
			...
			function(){
				$.post('<?php echo site_url() ?>schedule/delete/'+id, {}, function(res) {
					table.ajax.reload();
					swal({
						title: "Deleted!",
						text: "The Time Schedule has been deleted.",
						type: "success",
