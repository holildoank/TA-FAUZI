...
INSERT INTO `t_product` VALUES ('2', 'cuci rambut basah dengan warna', 'adalah cuci rambut dengan pewarna', '10000', '2', '2', '40', '10000', 'y', '1', '2016-09-30 13:22:52', '1', '2016-10-01 08:32:00');
INSERT INTO `t_product` VALUES ('3', 'perwatan Muka dengan menghilangkan jerawat', 'untuk mempercantik diri anda dengan teknik modern yang memberikan sensai penampilan anda semakin OKE! tanpa mengganggu tubuh banda', '10000', '3', '2', '30', '4000000', 'y', '1', '2016-09-30 13:25:20', '1', '2016-10-01 08:32:03');
...
CREATE TABLE `t_reservation` (
  ...
  `reservation_active` int(10) DEFAULT NULL,
  `reservation_createby` int(11) DEFAULT NULL,
  `reservation_enddatime` datetime DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `t_reservation` VALUES ('1', null, '1', '2016-09-30 14:45:00', '2016-09-30 15:15:00', 'pending', null, null, null, null, null, null, '2016-09-30 13:45:26', null, null);
INSERT INTO `t_reservation` VALUES ('2', null, '1', '2016-09-30 15:55:00', '2016-09-30 16:25:00', 'closed', null, null, null, null, null, null, '2016-09-30 13:46:20', '1', '2016-09-30 13:46:51');
INSERT INTO `t_reservation` VALUES ('3', null, '3', '2016-09-30 15:55:00', '2016-09-30 16:25:00', 'closed', 'BCA', '600000', null, '0', null, null, '2016-09-30 13:47:32', '1', '2016-09-30 16:38:07');
INSERT INTO `t_reservation` VALUES ('4', null, '4', '2016-10-29 19:30:00', '2016-10-29 07:00:00', 'pending', null, null, null, null, null, null, '2016-10-02 19:31:38', null, null);
INSERT INTO `t_reservation` VALUES ('5', null, '4', '2016-10-29 19:30:00', '2016-10-29 07:00:00', 'pending', null, null, null, null, null, null, '2016-10-02 19:32:19', null, null);
INSERT INTO `t_reservation` VALUES ('6', null, '4', '2016-10-29 19:35:00', '2016-10-29 07:00:00', 'closed', null, null, null, null, null, null, '2016-10-02 19:32:58', '1', '2016-10-02 19:35:44');
INSERT INTO `t_reservation` VALUES ('7', null, '4', '2016-10-29 19:30:00', '2016-10-29 07:00:00', 'closed', null, null, null, '0', null, null, '2016-10-02 19:35:07', '1', '2016-10-02 19:35:58');
INSERT INTO `t_reservation` VALUES ('8', null, '4', '2016-10-29 19:35:00', '2016-10-29 07:00:00', 'pending', null, null, null, '0', null, null, '2016-10-02 19:36:23', null, null);
INSERT INTO `t_reservation` VALUES ('9', null, '4', '2016-10-29 19:35:00', '2016-10-29 07:00:00', 'pending', null, null, null, '0', null, null, '2016-10-02 19:38:28', null, null);
INSERT INTO `t_reservation` VALUES ('10', null, '4', '2016-10-29 19:35:00', '2016-10-29 07:00:00', 'pending', null, null, null, '0', null, null, '2016-10-02 19:39:35', null, null);
INSERT INTO `t_reservation` VALUES ('11', null, '4', '2016-10-29 19:35:00', '2016-10-29 19:45:00', 'pending', null, null, null, '0', null, null, '2016-10-02 19:40:13', null, null);
...
-- ----------------------------
INSERT INTO `t_schedule_staff` VALUES ('1', '1', '2016-10-06', '07:00:00', '16:25:00', 'y', 'close', '1', 'come', '2016-10-06 14:11:48', null, '2016-10-06 22:30:32');
INSERT INTO `t_schedule_staff` VALUES ('2', '2', '2016-10-07', '07:00:00', '16:30:00', 'y', 'open', '1', 'come', '2016-10-06 14:15:50', null, null);
INSERT INTO `t_schedule_staff` VALUES ('3', '1', '2016-10-08', '07:25:00', '14:15:00', 'y', 'open', '1', 'come', '2016-10-06 14:21:29', null, null);
INSERT INTO `t_schedule_staff` VALUES ('4', '3', '2016-10-11', '07:00:00', '16:30:00', 'y', 'open', '1', 'come', '2016-10-06 14:21:51', null, null);
...
t_schedule_staff.schedule_status,
m_staff.staff_photo,
m_staff.staff_position
FROM
t_product
LEFT JOIN m_staff ON t_product.staff_id = m_staff.staff_id
LEFT JOIN t_schedule_staff ON t_schedule_staff.staff_id = m_staff.staff_id
...
FROM
t_product
INNER JOIN m_staff ON t_product.staff_id = m_staff.staff_id
INNER JOIN t_reservation ON t_reservation.product_id = t_product.product_id
INNER JOIN t_customer ON t_reservation.customer_id = t_customer.`
customer_id` ;
